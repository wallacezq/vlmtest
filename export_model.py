#!/usr/bin/env python3
"""
Pre-export Qwen2-VL-2B-Instruct to OpenVINO IR format (INT4 weight compression).
...
def main():
    parser = argparse.ArgumentParser(description="Export Qwen2-VL to OpenVINO IR")
    parser.add_argument(
        "--model",
